...
const Hero = () => {
  ...
  useEffect(() => {
    const fetchUserWishlist = async () => {
      ...
      if (snap.exists()) {
        setWishlist(new Set(snap.data().wishlist || []));
      }
    };
      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            Unleash your style and express individuality with our new
            collection, designed to elevate your wardrobe and make a bold
          ...
          <div className="hero-product-actions">
            <button
              className={`wishlist-icon-btn ${
                wishlist.has(currentProduct.id) ? "active" : ""
              }`}
