...
const footerData = {
  about: {
    title: "About Us",
    description:
      "Jumanaben is your premier destination for stylish and affordable fashion. We curate the latest trends to bring you quality clothing that expresses your unique style.",
  },
  quickLinks: [
    { name: "Home", link: "#" },
    { name: "Products", link: "#" },
